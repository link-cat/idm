 ...
 * <!-- end-user-doc -->
 * @see api_rest.Api_restPackage#getHTTP_METHOD()
 * @model
 * @generated
 */
public enum HTTP_METHOD implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final HTTP_METHOD[] VALUES_ARRAY = new HTTP_METHOD[] { GET, POST, PUT, DELETE, PATCH, };
	 ...
	 * @generated
	 */
	public static final List<HTTP_METHOD> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static HTTP_METHOD get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			HTTP_METHOD result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static HTTP_METHOD getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			HTTP_METHOD result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static HTTP_METHOD get(int value) {
		switch (value) {
		case GET_VALUE:
			return GET;
		case POST_VALUE:
	 ...
	 * @generated
	 */
	private HTTP_METHOD(int value, String name, String literal) {
		this.value = value;
		this.name = name;
