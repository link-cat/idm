...
/**
 * This is the item provider adapter for a {@link com.link.site.Formation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Formation_nom_feature",
								"_UI_Formation_type"),
						SitePackage.Literals.FORMATION__NOM, true, false, false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Formation_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Formation_description_feature",
								"_UI_Formation_type"),
						SitePackage.Literals.FORMATION__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Formation_niveau_feature",
								"_UI_Formation_type"),
						SitePackage.Literals.FORMATION__NIVEAU, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SitePackage.Literals.FORMATION__NIVEAU);
			childrenFeatures.add(SitePackage.Literals.FORMATION__SPECIALITE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(SitePackage.Literals.FORMATION__NIVEAU, SiteFactory.eINSTANCE.createNiveau()));

		newChildDescriptors.add(createChildParameter(SitePackage.Literals.FORMATION__SPECIALITE,
				SiteFactory.eINSTANCE.createSpecialite()));
	}
