 ...
 * </p>
 * <ul>
 *   <li>{@link com.link.site.impl.SemestreImpl#getNom <em>Nom</em>}</li>
 *   <li>{@link com.link.site.impl.SemestreImpl#getUe <em>Ue</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemestreImpl extends MinimalEObjectImpl.Container implements Semestre {
	...
	protected EClass eStaticClass() {
		return SitePackage.Literals.SEMESTRE;
	}
	...
	public void setNom(String newNom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SitePackage.SEMESTRE__NOM, oldNom, nom));
	}
	...
	public EList<UE> getUe() {
		if (ue == null) {
			ue = new EObjectContainmentEList<UE>(UE.class, this, SitePackage.SEMESTRE__UE);
		}
		return ue;
	}
